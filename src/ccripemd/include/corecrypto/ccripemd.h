...
/* RIPEMD has the same block size universally. */
#define CCRIPEMD_BLOCK_SIZE  64

#define CCRMD160_OUTPUT_SIZE 20
#define CCRMD160_STATE_SIZE  20
#define CCRMD160_BLOCK_SIZE  CCRIPEMD_BLOCK_SIZE
...
/*
 * RIPEMD digests of sizes that aren't 160 bits were removed after 2019.
 *
 * To retain backwards compatibility, keep the functionality usable but deprecated.
 *
 * This should hopefully make it compatible with earlier userspaces.
 */

#define CCRMD128_OUTPUT_SIZE 16
#define CCRMD128_STATE_SIZE  16
#define CCRMD128_BLOCK_SIZE  CCRIPEMD_BLOCK_SIZE

#define ccoid_rmd128 ((unsigned char *)"\x06\x05\x2B\x24\x03\x02\x02")
#define ccoid_rmd128_len 7

extern const struct ccdigest_info ccrmd128_ltc_di CC_API_DEPRECATED_FALL_2019;

#define ccrmd128_di ccrmd128_ltc_di

#define CCRMD256_OUTPUT_SIZE 32
#define CCRMD256_STATE_SIZE  32
#define CCRMD256_BLOCK_SIZE  CCRIPEMD_BLOCK_SIZE

#define ccoid_rmd256 ((unsigned char *)"\x06\x05\x2B\x24\x03\x02\x03")
#define ccoid_rmd256_len 7

extern const struct ccdigest_info ccrmd256_ltc_di CC_API_DEPRECATED_FALL_2019;

#define ccrmd256_di ccrmd256_ltc_di

#define CCRMD320_OUTPUT_SIZE 40
#define CCRMD320_STATE_SIZE  40
#define CCRMD320_BLOCK_SIZE  CCRIPEMD_BLOCK_SIZE

/*
 * No OID for RMD320.
 */

extern const struct ccdigest_info ccrmd320_ltc_di CC_API_DEPRECATED_FALL_2019;
