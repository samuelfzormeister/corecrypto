...
#if 0
aes_rval vng_decrypt_cbc(const unsigned char *ibuf, unsigned char *iv, unsigned int num_blk,
...
9:	
	...
	// we are done here, the finishing code is identical to that in vng_encrypt_cbc, so just jump to there
